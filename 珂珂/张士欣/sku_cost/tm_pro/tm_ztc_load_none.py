...
class ZtcSkuLoad():
    def __init__(self):
        ...
        # self.delete_jzt_sql = 'delete from tm_ztc_sku_none where create_date="%s" and sku_code IS NOT NULL'
        ...
        # self.get_jzt_sql = 'select sku_id,sku_cost,sku_code,shop_type,shop_name,create_date,sku_type from %s where create_date="%s" '
